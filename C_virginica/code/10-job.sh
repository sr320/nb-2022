...
#SBATCH --chdir=/gscratch/scrubbed/sr320/022122-tecg-cov
...
FILES=$(ls *sorted.bam)
cd /gscratch/scrubbed/sr320/022122-tecg-cov
for file in ${FILES}
do
    ...
    -mean \
    -sorted \
    -a /gscratch/srlab/sr320/data/Cvirg-genome/C_virginica-3.0_TE-Cg.gff \
    -b /gscratch/scrubbed/sr320/021022-CvBSnp/${NAME}.deduplicated.sorted.bam \
    > ${NAME}_te-cgcov_m.out
done